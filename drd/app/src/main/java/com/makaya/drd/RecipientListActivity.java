...
public class RecipientListActivity extends AppCompatActivity {
    Activity activity;
    ArrayList<MemberLite> members =new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PublicFunction.setHeaderStatus(activity, "Recipient", new PublicFunction.BackCallbackInterface() {
            @Override
    ...
    private void bindRecyclerView()
    {
        ...
        adapter = new RecipientListAdapter(members, activity);
