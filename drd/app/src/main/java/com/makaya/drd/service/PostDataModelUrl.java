...
public class PostDataModelUrl<T> extends AsyncTask<Object, Void, T> {
    ...
    /*
    // posted error
    private OnSetPostedErrorListener onSetPostedErrorListener;
    public interface OnSetPostedErrorListener {
        public <T> void onPostedError(Exception data);
    }

    public void setOnDataPostedListener(OnSetPostedErrorListener listener) {
        onSetPostedErrorListener = listener;
    }
    */
    ...
    private <T> T postUrl(String strUrl, T dataObject, Class<T> type) throws IOException {
