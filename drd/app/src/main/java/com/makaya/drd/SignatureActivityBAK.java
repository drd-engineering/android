...
public class SignatureActivityBAK extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PublicFunction.setHeaderStatus(activity,"Signature/Initial Pane");
        ...
        public void onClick(View v) {
            ...
            if (v == mClear) {
                ...
                if (Build.VERSION.SDK_INT >= 23)
                    granted=isStoragePermissionGranted();
                else
                    granted=true;
                ...
                if (granted) {
                    ...
                    Toast.makeText(getApplicationContext(), "Not allowed to save file to storage.", Toast.LENGTH_SHORT).show();
                }
            } else if(v == mCancel){
