...
public class InvitationListAdapterBak extends
        RecyclerView.Adapter<InvitationListAdapterBak.InboxViewHolder>{
    ...
    public InvitationListAdapterBak(ArrayList<MemberInvited> members, Activity activity){
