...
public class PaymentViaGeraiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.payment_via_gerai);
        activity=this;
        /*PublicFunction2.setStatusBarColor(this, R.color.colorBased);
        TextView title=(TextView)findViewById(R.id.appBarTitle);
        title.setText("PAYMENT VIA GERAI");
        title.setVisibility(View.VISIBLE);*/
        PublicFunction.setHeaderStatus(activity,"Payment Via Gerai");
