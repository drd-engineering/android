...
import com.makaya.drd.service.StampService;
...
public class StampListActivity extends AppCompatActivity {
    Activity activity;
    ArrayList<StampLite> stamps =new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PublicFunction.setHeaderStatus(activity, "Stamp", new PublicFunction.BackCallbackInterface() {
            @Override
    ...
    private void bindRecyclerView()
    {
        ...
        adapter = new StampListAdapter(stamps, activity);
    ...
    {
        StampService svr=new StampService(activity);
        svr.setOnDataPostedListener(new StampService.OnSetDataPostedListener() {
            @Override
            public <T> void onDataPosted(T data, boolean isLoadedAllItems) {
                ArrayList<StampLite> datas=((StampLiteRoot) data).Root;
        ...
        svr.getList(userId, topCriteria, page);
    }
