...
public class InvitationInviteFragment extends Fragment {
    Activity activity;
    ...
    MemberLogin user;
    InvitationInviteAdapter adapter;
    int screenWidth;
    TextView search;
    ImageView imgClear;
    String topCriteria="";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view=inflater.inflate(R.layout.invitation_invite, container, false);
    ...
    private void bindRecyclerView()
    {
        ...
        adapter = new InvitationInviteAdapter(members, activity);
    ...
    private void fetchData(long userId, String topCriteria, int page)
    {
        ...
        svr.getInvitedList(userId, topCriteria, page);
    }
